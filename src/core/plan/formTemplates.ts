...
const FORM_TEMPLATES: FormTemplate[] = [
    ...
    },
    {
        ...
        symbolicFirst: true,
        minSections: 5,
        requiredRoles: ["theme_a", "theme_b", "bridge", "recap"],
        ...
        sectionBlueprints: [
            {
                ...
                tensionTarget: 0.38,
                allowModulation: false,
                notes: ["Establish the main refrain clearly in the home key with a clean authentic close."],
            },
            {
                id: "r2",
                role: "theme_b",
                ...
                tensionTarget: 0.58,
                allowModulation: true,
                notes: ["Contrast the refrain by moving to a secondary key area and varying texture or register."],
            },
            {
                id: "r3",
                role: "recap",
                label: "Refrain return (A)",
                measures: 8,
                energy: 0.44,
                density: 0.36,
                cadence: "half",
                ...
                tensionTarget: 0.32,
                allowModulation: false,
                notes: ["Return the refrain in the home key; may be slightly shortened relative to r1."],
            },
            {
                id: "r4",
                role: "bridge",
                ...
                tensionTarget: 0.68,
                allowModulation: true,
                notes: ["Provide a second contrasting episode; darker or more harmonically adventurous than Episode I."],
            },
            {
                id: "r5",
                role: "recap",
                label: "Final refrain (A)",
                measures: 8,
                energy: 0.42,
                density: 0.35,
                cadence: "authentic",
                ...
                tensionTarget: 0.2,
                allowModulation: false,
                notes: ["Return the refrain in full for a conclusive close in the home key."],
            },
        ],
    },
    {
        ...
        sectionBlueprints: [
            {
                ...
                tensionTarget: 0.35,
                allowModulation: false,
                notes: ["Present the theme plainly in the home key so later variations remain recognizable."],
            },
            {
                id: "tv2",
                role: "variation",
                label: "Variation I – rhythm",
                measures: 8,
                energy: 0.55,
                density: 0.48,
                cadence: "half",
                ...
                tensionTarget: 0.52,
                allowModulation: false,
                notes: ["Preserve harmonic outline from tv1; transform the surface rhythm and figuration."],
            },
            {
                id: "tv3",
                role: "variation",
                label: "Variation II – texture",
                measures: 8,
                energy: 0.5,
                density: 0.46,
                cadence: "half",
                ...
                tensionTarget: 0.5,
                allowModulation: false,
                notes: ["Keep the melody recognizable while altering register, voicing spread, or accompanimental texture."],
            },
            {
                id: "tv4",
                role: "variation",
                label: "Variation III – harmony",
                measures: 8,
                energy: 0.6,
                density: 0.52,
                cadence: "half",
                ...
                tensionTarget: 0.64,
                allowModulation: true,
                notes: ["Explore a modal shift or secondary key area, reharmonizing the theme for maximum contrast."],
            },
            {
                id: "tv5",
                role: "cadence",
                ...
                tensionTarget: 0.18,
                allowModulation: false,
                notes: ["Recall the original theme briefly and close with a definitive authentic cadence in the home key."],
            },
        ],
    },
    {
        ...
        symbolicFirst: true,
        minSections: 5,
        requiredRoles: ["theme_a", "bridge", "development", "recap", "cadence"],
        qualityProfile: "formal_classical",
        guidance: [
        ...
        sectionBlueprints: [
            {
                ...
                tensionTarget: 0.3,
                allowModulation: false,
                notes: ["Present the subject in a single voice against a light or silent accompaniment."],
            },
            {
                id: "f2",
                role: "bridge",
                ...
                tensionTarget: 0.38,
                allowModulation: true,
                notes: ["State the answer on the dominant, preserving the subject shape at the interval of a fifth."],
            },
            {
                id: "f3",
                role: "development",
                ...
                tensionTarget: 0.74,
                allowModulation: true,
                notes: ["Develop fragments of the subject sequentially; allow voices to trade material across registers."],
            },
            {
                id: "f4",
                role: "recap",
                label: "Stretto-like return",
                measures: 6,
                energy: 0.72,
                density: 0.62,
                cadence: "half",
                ...
                tensionTarget: 0.8,
                allowModulation: false,
                notes: ["Re-enter the subject in close imitation, building density and urgency toward the final cadence."],
            },
            {
                id: "f5",
                role: "cadence",
                ...
                tensionTarget: 0.12,
                allowModulation: false,
                notes: ["Resolve to a firm authentic cadence in the home key; a pedal point may reinforce tonic arrival."],
            },
        ],
    },
];
