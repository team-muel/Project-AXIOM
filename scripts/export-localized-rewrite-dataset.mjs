import { exportLocalizedRewriteDataset } from "./export-structure-reranker-dataset.mjs";
...
try {
    ...
    const manifest = exportLocalizedRewriteDataset({ outputRoot, snapshotId });
    process.stdout.write(`${JSON.stringify(manifest, null, 2)}\n`);
} catch (error) {
    fail("Failed to export localized rewrite dataset", {
